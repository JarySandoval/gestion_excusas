                      ...
                      <div>
                        {docenteBloqueado ? (
                          <button
                            ...
                            className="flex items-center gap-1 px-3 py-1.5 bg-slate-100 text-slate-400 rounded-lg text-xs font-semibold cursor-not-allowed border border-slate-200"
                          >
                          ...
                          <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 bg-blue-900 hover:bg-blue-800 text-white rounded-lg text-xs font-semibold transition-colors shadow-2xs"
                          >
              ...
              <form onSubmit={handleRegistrarSeguimiento} className="space-y-2 pt-2">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    required
                    className="flex-1 px-3.5 py-2 text-xs bg-slate-50 border border-slate-300 rounded-xl focus:bg-white focus:ring-2 focus:ring-purple-600 focus:outline-hidden"
                  />
                  <button
                    type="submit"
                    disabled={enviandoObservacion || !nuevaObservacion.trim()}
                    className="flex items-center gap-1.5 px-4 py-2 bg-purple-800 hover:bg-purple-900 text-white rounded-xl text-xs font-bold transition-colors disabled:opacity-50 cursor-pointer shadow-2xs"
                  >
