...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-blue-950 via-slate-900 to-blue-900 flex flex-col justify-center items-center p-4">
      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-6">
          <div className="w-16 h-16 rounded-2xl bg-white/10 backdrop-blur-md text-white border border-white/20 flex items-center justify-center mx-auto mb-3 shadow-lg">
          ...
          <div className="pt-4 border-t border-slate-100 space-y-2">
            ...
            <div className="grid grid-cols-3 gap-2 text-[11px]">
              <button
                ...
                className="p-2 text-center rounded-lg bg-purple-50 hover:bg-purple-100 text-purple-900 font-semibold border border-purple-200 transition-colors"
              >
                Coordinador
              </button>
              <button
                ...
                className="p-2 text-center rounded-lg bg-blue-50 hover:bg-blue-100 text-blue-900 font-semibold border border-blue-200 transition-colors"
              >
                Docente
              </button>
              <button
                ...
                className="p-2 text-center rounded-lg bg-emerald-50 hover:bg-emerald-100 text-emerald-900 font-semibold border border-emerald-200 transition-colors"
              >
                Estudiante
              </button>
            </div>
